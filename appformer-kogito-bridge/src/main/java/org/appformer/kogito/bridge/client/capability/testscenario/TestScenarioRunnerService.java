...
public class TestScenarioRunnerService implements TestScenarioRunnerCapability {

    @Override
    public Promise<CapabilityResponse<TestScenarioRunResult>> run(String xmlContent) {
        return getWrapper().run(xmlContent);
    }
    ...
    TestScenarioRunnerWrapper getWrapper() {
        return TestScenarioRunnerWrapper.get();
    }
