...
public class TestScenarioRunnerWrapper {

    @JsMethod
    public native Promise<CapabilityResponse<TestScenarioRunResult>> run(String xmlContent);

    @JsProperty(name = "testScenarioRunnerService")
    public static native TestScenarioRunnerWrapper get();
